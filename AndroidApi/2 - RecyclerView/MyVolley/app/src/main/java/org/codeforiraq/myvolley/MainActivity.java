...
import org.codeforiraq.myvolley.Controller.Adapter;
...
import org.codeforiraq.myvolley.UI.AddData;
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for(int i=0 ; i< booksArray.length(); i ++){
                        ...
                        Log.d("books", book.getId() +" - " + book.getName()+" - " +
                                 book.getAuthor()+" - " +  book.getCreated_at());
